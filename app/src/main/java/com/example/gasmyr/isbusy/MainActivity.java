...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent messageSettings = new Intent(getApplicationContext(), MessageSettings.class);
            startActivity(messageSettings);
            return true;
        }
        if (id == R.id.action_author) {
            Intent sim = new Intent(getApplicationContext(), Author.class);
            startActivity(sim);
            return true;
        }
        if (id == R.id.action_doc) {
            Intent documentation = new Intent(getApplicationContext(), Documentation.class);
